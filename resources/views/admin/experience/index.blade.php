    ...
    <div class="modal-content">
      ...
      <form action="{{ url('/upload') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control"   placeholder="Write your company name .." require>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="text" class="form-control" id="editor" rows="3" placeholder="Write your client paragraph .." require></textarea>
              ...
              <tbody> 
                ...
                <tr>
                  ...
                  <td> <button type="button" class="btn btn-warning">
                    <a href="{{url('/edit_experience',$data->id )}}"> Edit</a></button></td>
