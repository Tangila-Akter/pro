    ...
    <div class="modal-content">
      ...
      <form action="{{ url('/upload') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="purecounter" class="form-control"   placeholder="Write your purecounter number" require>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Fact Header <span class="text-danger">*</span></label>
            <input type="text" name="header" class="form-control"   placeholder="Write your Fact header here.." require>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Text <span class="text-danger">*</span></label>
            <input type="text" name="text" class="form-control"   placeholder="Write your text" require>
        </div>
